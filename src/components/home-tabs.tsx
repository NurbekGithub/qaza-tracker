...
export function HomeTabs({ isLoading, prayers, events, onPrayerClick }: HomeTabsProps) {
  return (
    <Tabs defaultValue="counts" className="flex-col">
      ...
      <div className="fixed inset-x-0 bottom-0 border-t border-border bg-background pb-safe">
        <TabsList className="mx-auto flex h-12! w-full max-w-2xl justify-around gap-2 rounded-none bg-transparent p-1.5 text-lg">
          <TabsTrigger
            value="counts"
